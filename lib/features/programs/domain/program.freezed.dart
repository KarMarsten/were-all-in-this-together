...
mixin _$Program {
 ...
 String get id; String get personId; ProgramKind get kind; String get name; DateTime get createdAt; DateTime get updatedAt; String? get phone; String? get notes; DateTime? get deletedAt; int get rowVersion; String? get lastWriterDeviceId; int get keyVersion;
...
@override
int get hashCode => Object.hash(runtimeType,id,personId,kind,name,createdAt,updatedAt,phone,notes,deletedAt,rowVersion,lastWriterDeviceId,keyVersion);

@override
String toString() {
  return 'Program(id: $id, personId: $personId, kind: $kind, name: $name, createdAt: $createdAt, updatedAt: $updatedAt, phone: $phone, notes: $notes, deletedAt: $deletedAt, rowVersion: $rowVersion, lastWriterDeviceId: $lastWriterDeviceId, keyVersion: $keyVersion)';
}
...
@useResult
$Res call({
 String id, String personId, ProgramKind kind, String name, DateTime createdAt, DateTime updatedAt, String? phone, String? notes, DateTime? deletedAt, int rowVersion, String? lastWriterDeviceId, int keyVersion
});
...
/// Create a copy of Program
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? personId = null,Object? kind = null,Object? name = null,Object? createdAt = null,Object? updatedAt = null,Object? phone = freezed,Object? notes = freezed,Object? deletedAt = freezed,Object? rowVersion = null,Object? lastWriterDeviceId = freezed,Object? keyVersion = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String personId,  ProgramKind kind,  String name,  DateTime createdAt,  DateTime updatedAt,  String? phone,  String? notes,  DateTime? deletedAt,  int rowVersion,  String? lastWriterDeviceId,  int keyVersion)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Program() when $default != null:
return $default(_that.id,_that.personId,_that.kind,_that.name,_that.createdAt,_that.updatedAt,_that.phone,_that.notes,_that.deletedAt,_that.rowVersion,_that.lastWriterDeviceId,_that.keyVersion);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String personId,  ProgramKind kind,  String name,  DateTime createdAt,  DateTime updatedAt,  String? phone,  String? notes,  DateTime? deletedAt,  int rowVersion,  String? lastWriterDeviceId,  int keyVersion)  $default,) {final _that = this;
switch (_that) {
case _Program():
return $default(_that.id,_that.personId,_that.kind,_that.name,_that.createdAt,_that.updatedAt,_that.phone,_that.notes,_that.deletedAt,_that.rowVersion,_that.lastWriterDeviceId,_that.keyVersion);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String personId,  ProgramKind kind,  String name,  DateTime createdAt,  DateTime updatedAt,  String? phone,  String? notes,  DateTime? deletedAt,  int rowVersion,  String? lastWriterDeviceId,  int keyVersion)?  $default,) {final _that = this;
switch (_that) {
case _Program() when $default != null:
return $default(_that.id,_that.personId,_that.kind,_that.name,_that.createdAt,_that.updatedAt,_that.phone,_that.notes,_that.deletedAt,_that.rowVersion,_that.lastWriterDeviceId,_that.keyVersion);case _:
  return null;
...
class _Program implements Program {
  const _Program({required this.id, required this.personId, required this.kind, required this.name, required this.createdAt, required this.updatedAt, this.phone, this.notes, this.deletedAt, this.rowVersion = 1, this.lastWriterDeviceId, this.keyVersion = 1});
