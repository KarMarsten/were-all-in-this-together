...
mixin _$Program {
 ...
 String get id; String get personId; ProgramKind get kind; String get name; DateTime get createdAt; DateTime get updatedAt; String? get phone; String? get contactName; String? get contactRole; String? get email; String? get address; String? get websiteUrl; String? get hours; String? get notes; String? get providerId; DateTime? get deletedAt; int get rowVersion; String? get lastWriterDeviceId; int get keyVersion;
...
@override
int get hashCode => Object.hashAll([runtimeType,id,personId,kind,name,createdAt,updatedAt,phone,contactName,contactRole,email,address,websiteUrl,hours,notes,providerId,deletedAt,rowVersion,lastWriterDeviceId,keyVersion]);

@override
String toString() {
  return 'Program(id: $id, personId: $personId, kind: $kind, name: $name, createdAt: $createdAt, updatedAt: $updatedAt, phone: $phone, contactName: $contactName, contactRole: $contactRole, email: $email, address: $address, websiteUrl: $websiteUrl, hours: $hours, notes: $notes, providerId: $providerId, deletedAt: $deletedAt, rowVersion: $rowVersion, lastWriterDeviceId: $lastWriterDeviceId, keyVersion: $keyVersion)';
}
...
@useResult
$Res call({
 String id, String personId, ProgramKind kind, String name, DateTime createdAt, DateTime updatedAt, String? phone, String? contactName, String? contactRole, String? email, String? address, String? websiteUrl, String? hours, String? notes, String? providerId, DateTime? deletedAt, int rowVersion, String? lastWriterDeviceId, int keyVersion
});
...
/// Create a copy of Program
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? personId = null,Object? kind = null,Object? name = null,Object? createdAt = null,Object? updatedAt = null,Object? phone = freezed,Object? contactName = freezed,Object? contactRole = freezed,Object? email = freezed,Object? address = freezed,Object? websiteUrl = freezed,Object? hours = freezed,Object? notes = freezed,Object? providerId = freezed,Object? deletedAt = freezed,Object? rowVersion = null,Object? lastWriterDeviceId = freezed,Object? keyVersion = null,}) {
...
switch (_that) {
case _Program() when $default != null:
return $default(_that.id,_that.personId,_that.kind,_that.name,_that.createdAt,_that.updatedAt,_that.phone,_that.contactName,_that.contactRole,_that.email,_that.address,_that.websiteUrl,_that.hours,_that.notes,_that.providerId,_that.deletedAt,_that.rowVersion,_that.lastWriterDeviceId,_that.keyVersion);case _:
  return orElse();
...
class _Program implements Program {
  const _Program({required this.id, required this.personId, required this.kind, required this.name, required this.createdAt, required this.updatedAt, this.phone, this.contactName, this.contactRole, this.email, this.address, this.websiteUrl, this.hours, this.notes, this.providerId, this.deletedAt, this.rowVersion = 1, this.lastWriterDeviceId, this.keyVersion = 1});
