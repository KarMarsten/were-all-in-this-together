...
class CareProviderRepository {
  ...
  Future<CareProvider> update(CareProvider updated) async {
    ...
    final payload = EncryptedCareProviderPayload(
      ...
      portalLabel: updated.portalLabel,
      portalUrl: updated.portalUrl,
      afterHoursPhone: updated.afterHoursPhone,
      afterHoursInstructions: updated.afterHoursInstructions,
      notes: updated.notes,
    );
    final encrypted = await _sealPayload(
      careProviderId: updated.id,
  ...
  Future<CareProvider> _decode(CareProviderRow row) async {
    ...
    return CareProvider(
      ...
      afterHoursPhone: payload.afterHoursPhone,
      afterHoursInstructions: payload.afterHoursInstructions,
      notes: payload.notes,
      createdAt:
