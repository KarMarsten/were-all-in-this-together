...
/// so clinical precision can grow without schema changes.
 String? get specialty;/// Practical role / relationship label for handoffs, e.g.
/// "medication prescriber", "IEP contact", or "care coordinator".
 String? get role;/// Named contact when the organization is the provider record.
 String? get contactName;/// Dialable phone number (free-form — we don't parse or format).
 String? get phone;/// Email address for the provider / office / portal support.
 String? get email;/// Fax number for forms, releases, and school / clinic handoffs.
 String? get fax;/// Single-line address for lookup / navigation. We deliberately do
/// not structure this — users paste from Contacts and Maps handles
/// the rest.
 String? get address;/// Human label for [portalUrl], e.g. "MyChart" or "Therapy portal".
 String? get portalLabel;/// Patient portal URL. Expected to be `http(s)://…`; validated at
/// the form layer, not here.
 String? get portalUrl;/// After-hours dialable number when it differs from [phone].
 String? get afterHoursPhone;/// Free-text instructions for urgent / after-hours routing.
 String? get afterHoursInstructions;/// Free-form notes — office hours, receptionist's name, in-network
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CareProvider&&(identical(other.id, id) || other.id == id)&&(identical(other.personId, personId) || other.personId == personId)&&(identical(other.name, name) || other.name == name)&&(identical(other.kind, kind) || other.kind == kind)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.specialty, specialty) || other.specialty == specialty)&&(identical(other.role, role) || other.role == role)&&(identical(other.contactName, contactName) || other.contactName == contactName)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.email, email) || other.email == email)&&(identical(other.fax, fax) || other.fax == fax)&&(identical(other.address, address) || other.address == address)&&(identical(other.portalLabel, portalLabel) || other.portalLabel == portalLabel)&&(identical(other.portalUrl, portalUrl) || other.portalUrl == portalUrl)&&(identical(other.afterHoursPhone, afterHoursPhone) || other.afterHoursPhone == afterHoursPhone)&&(identical(other.afterHoursInstructions, afterHoursInstructions) || other.afterHoursInstructions == afterHoursInstructions)&&(identical(other.notes, notes) || other.notes == notes)&&(identical(other.deletedAt, deletedAt) || other.deletedAt == deletedAt)&&(identical(other.rowVersion, rowVersion) || other.rowVersion == rowVersion)&&(identical(other.lastWriterDeviceId, lastWriterDeviceId) || other.lastWriterDeviceId == lastWriterDeviceId)&&(identical(other.keyVersion, keyVersion) || other.keyVersion == keyVersion));
}


@override
int get hashCode => Object.hashAll([runtimeType,id,personId,name,kind,createdAt,updatedAt,specialty,role,contactName,phone,email,fax,address,portalLabel,portalUrl,afterHoursPhone,afterHoursInstructions,notes,deletedAt,rowVersion,lastWriterDeviceId,keyVersion]);

@override
String toString() {
  return 'CareProvider(id: $id, personId: $personId, name: $name, kind: $kind, createdAt: $createdAt, updatedAt: $updatedAt, specialty: $specialty, role: $role, contactName: $contactName, phone: $phone, email: $email, fax: $fax, address: $address, portalLabel: $portalLabel, portalUrl: $portalUrl, afterHoursPhone: $afterHoursPhone, afterHoursInstructions: $afterHoursInstructions, notes: $notes, deletedAt: $deletedAt, rowVersion: $rowVersion, lastWriterDeviceId: $lastWriterDeviceId, keyVersion: $keyVersion)';
}
...
@useResult
$Res call({
 String id, String personId, String name, CareProviderKind kind, DateTime createdAt, DateTime updatedAt, String? specialty, String? role, String? contactName, String? phone, String? email, String? fax, String? address, String? portalLabel, String? portalUrl, String? afterHoursPhone, String? afterHoursInstructions, String? notes, DateTime? deletedAt, int rowVersion, String? lastWriterDeviceId, int keyVersion
});
...
/// Create a copy of CareProvider
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? personId = null,Object? name = null,Object? kind = null,Object? createdAt = null,Object? updatedAt = null,Object? specialty = freezed,Object? role = freezed,Object? contactName = freezed,Object? phone = freezed,Object? email = freezed,Object? fax = freezed,Object? address = freezed,Object? portalLabel = freezed,Object? portalUrl = freezed,Object? afterHoursPhone = freezed,Object? afterHoursInstructions = freezed,Object? notes = freezed,Object? deletedAt = freezed,Object? rowVersion = null,Object? lastWriterDeviceId = freezed,Object? keyVersion = null,}) {
...
as String?,portalLabel: freezed == portalLabel ? _self.portalLabel : portalLabel // ignore: cast_nullable_to_non_nullable
as String?,portalUrl: freezed == portalUrl ? _self.portalUrl : portalUrl // ignore: cast_nullable_to_non_nullable
as String?,afterHoursPhone: freezed == afterHoursPhone ? _self.afterHoursPhone : afterHoursPhone // ignore: cast_nullable_to_non_nullable
as String?,afterHoursInstructions: freezed == afterHoursInstructions ? _self.afterHoursInstructions : afterHoursInstructions // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String personId,  String name,  CareProviderKind kind,  DateTime createdAt,  DateTime updatedAt,  String? specialty,  String? role,  String? contactName,  String? phone,  String? email,  String? fax,  String? address,  String? portalLabel,  String? portalUrl,  String? afterHoursPhone,  String? afterHoursInstructions,  String? notes,  DateTime? deletedAt,  int rowVersion,  String? lastWriterDeviceId,  int keyVersion)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CareProvider() when $default != null:
return $default(_that.id,_that.personId,_that.name,_that.kind,_that.createdAt,_that.updatedAt,_that.specialty,_that.role,_that.contactName,_that.phone,_that.email,_that.fax,_that.address,_that.portalLabel,_that.portalUrl,_that.afterHoursPhone,_that.afterHoursInstructions,_that.notes,_that.deletedAt,_that.rowVersion,_that.lastWriterDeviceId,_that.keyVersion);case _:
  return orElse();
...
class _CareProvider implements CareProvider {
  const _CareProvider({required this.id, required this.personId, required this.name, required this.kind, required this.createdAt, required this.updatedAt, this.specialty, this.role, this.contactName, this.phone, this.email, this.fax, this.address, this.portalLabel, this.portalUrl, this.afterHoursPhone, this.afterHoursInstructions, this.notes, this.deletedAt, this.rowVersion = 1, this.lastWriterDeviceId, this.keyVersion = 1});
...
@override final  String? portalLabel;
...
@override final  String? afterHoursPhone;
/// Free-text instructions for urgent / after-hours routing.
@override final  String? afterHoursInstructions;
