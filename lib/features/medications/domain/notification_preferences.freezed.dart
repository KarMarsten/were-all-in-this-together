...
mixin _$NotificationPreferences {
 ...
 int get nagIntervalMinutes; int get nagCap;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NotificationPreferences&&(identical(other.nagIntervalMinutes, nagIntervalMinutes) || other.nagIntervalMinutes == nagIntervalMinutes)&&(identical(other.nagCap, nagCap) || other.nagCap == nagCap));
}


@override
int get hashCode => Object.hash(runtimeType,nagIntervalMinutes,nagCap);

@override
String toString() {
  return 'NotificationPreferences(nagIntervalMinutes: $nagIntervalMinutes, nagCap: $nagCap)';
}
...
@useResult
$Res call({
 int nagIntervalMinutes, int nagCap
});
...
/// Create a copy of NotificationPreferences
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? nagIntervalMinutes = null,Object? nagCap = null,}) {
  return _then(_self.copyWith(
nagIntervalMinutes: null == nagIntervalMinutes ? _self.nagIntervalMinutes : nagIntervalMinutes // ignore: cast_nullable_to_non_nullable
as int,nagCap: null == nagCap ? _self.nagCap : nagCap // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int nagIntervalMinutes,  int nagCap)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationPreferences() when $default != null:
return $default(_that.nagIntervalMinutes,_that.nagCap);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int nagIntervalMinutes,  int nagCap)  $default,) {final _that = this;
switch (_that) {
case _NotificationPreferences():
return $default(_that.nagIntervalMinutes,_that.nagCap);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int nagIntervalMinutes,  int nagCap)?  $default,) {final _that = this;
switch (_that) {
case _NotificationPreferences() when $default != null:
return $default(_that.nagIntervalMinutes,_that.nagCap);case _:
  return null;
...
class _NotificationPreferences implements NotificationPreferences {
  const _NotificationPreferences({this.nagIntervalMinutes = 10, this.nagCap = 3});
  

@override@JsonKey() final  int nagIntervalMinutes;
@override@JsonKey() final  int nagCap;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NotificationPreferences&&(identical(other.nagIntervalMinutes, nagIntervalMinutes) || other.nagIntervalMinutes == nagIntervalMinutes)&&(identical(other.nagCap, nagCap) || other.nagCap == nagCap));
}
...
/// Create a copy of NotificationPreferences
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? nagIntervalMinutes = null,Object? nagCap = null,}) {
